...
public class Code93 extends ConfigurableBarcodeGenerator 
    ...
    public void configure(Configuration cfg) throws ConfigurationException {
        ...
        //Wide factor    
        getCode93Bean().setWideFactor(
            cfg.getChild("wide-factor").getValueAsFloat((float)Code93Bean.DEFAULT_WIDE_FACTOR));
...
//            getCode93Bean().setIntercharGapWidth(
//                    igw.getValue() * getCode93Bean().getModuleWidth());
//        } else {
//            getCode93Bean().setIntercharGapWidth(igw.getValueAsMillimeter());
//        }
